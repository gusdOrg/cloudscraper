...
module.exports = class Database {
    constructor() {
        this.serverUrl = "127.0.0.1:27017"
    }
    ...
    async start() {
        ...
        this.colLogins = this.crawler.collection("logins");
        this.colKeys = this.crawler.collection("api_keys");
        this.colCookies = this.crawler.collection("cookies");
    }
